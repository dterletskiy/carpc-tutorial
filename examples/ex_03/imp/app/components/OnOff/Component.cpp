   ...
   : carpc::application::RootComponent( _name )
{
   ...
   events::SimpleIdSigNoData::Event::set_notification( this, { events::eAppEventID::PING } );
   events::SimpleIdSig::Event::set_notification( this, { events::eAppEventID::SHUTDOWN } );
}
